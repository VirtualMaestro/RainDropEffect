...
namespace RainDropEffect2.Scripts.RainBehaviours.SimpleRain
{
    ...
    public class SimpleRainVariables
    {
        ...
        [Range(0.0f, 5.0f)] public float darkness = 4f;
        ...
        [Range(-2, 2f)] public float spawnOffsetY = 0.05f;

        [Range(0f, 10.0f)] public float lifetimeMin = 0.7f;
        [Range(0f, 10.0f)] public float lifetimeMax = 0.9f;

        [Range(0, 50f)] public int emissionRateMin = 15;
        [Range(0, 50f)] public int emissionRateMax = 17;

        public AnimationCurve alphaOverLifetime = _defaultAnimationCurve;

        [Range(0.0f, 20f)] public float sizeMinX = 0.26f;
        [Range(0.0f, 20f)] public float sizeMaxX = 0.35f;
        [Range(0.0f, 20f)] public float sizeMinY = 0.26f;
        [Range(0.0f, 20f)] public float sizeMaxY = 0.35f;
        public AnimationCurve sizeOverLifetime = _defaultAnimationCurve;

        [Range(0.0f, 200.0f)] public float distortionValue = 100f;
